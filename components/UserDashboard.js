    ...
    <div className='w-full max-w-[65ch] text-xs sm:text-sm mx-auto flex flex-col gap-3 sm:gap-5'>
        ...
        <div className='flex items-stretch'>
          ...
          <button
            ...
            className='w-fit px-4 sam:px-6 py-2 sm:py-3 bg-amber-400 text-white font-medium text-base duration-300 hover:opacity-40'>
            ADD
          </button>
        </div>
        ...
        {(!loading) && (
          <>
            ...
            <TodoCard handleEditTodo={handleEditTodo} key={i} handleAddEdit={handleAddEdit} edit={edit}
              todoKey={todo} edittedValue={edittedValue} handleDelete={handleDelete} setEdittedValue={setEdittedValue}>
              {todos[todo]}
            </TodoCard>
          ))}
          </>
